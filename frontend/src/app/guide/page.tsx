      ...
      <main className="flex-1 overflow-y-auto overflow-x-hidden p-6 pt-20 lg:p-10 space-y-8 relative">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-6 gap-4">
          ...
          <button
            ...
            className="self-start md:self-auto px-4 py-2 text-xs font-bold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-slate-900 dark:text-white rounded-xl shadow-lg hover:shadow-indigo-500/20 transition-all active:scale-[0.97] cursor-pointer flex items-center space-x-1.5"
          >
            <span>🚀</span>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
          ...
          <div className="xl:col-span-7 space-y-6">
            <div className="bg-white border border-slate-200 dark:border-slate-800/80 dark:border-slate-800/80 shadow-sm dark:bg-slate-900/40 dark:border-slate-800 dark:shadow-none border border-slate-200 dark:border-slate-800 p-6 rounded-2xl backdrop-blur-md">
              <h2 className="text-base sm:text-lg font-bold text-blue-600 dark:text-blue-400 mb-6 flex items-center space-x-2">
                <span>🔗</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/60 dark:border-slate-800/60 hover:border-blue-900/60 transition-all duration-300 group">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200">Tiến độ học</h3>
                  </div>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/60 dark:border-slate-800/60 hover:border-blue-900/60 transition-all duration-300 group">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200">Lộ trình học</h3>
                  </div>
                  <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/60 dark:border-slate-800/60 hover:border-blue-900/60 transition-all duration-300 group">
                  <div className="flex items-center space-x-3 mb-2">
                    <span className="text-2xl group-hover:scale-110 transition-transform">📚</span>
                    <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200">Từ vựng & Chữ Hán</h3>
                  </div>
                  <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed">
          ...
          <div className="xl:col-span-5 space-y-6">
            ...
            {/* 5 Steps timeline */}
            <div className="bg-white border border-slate-200 dark:border-slate-800/80 dark:border-slate-800/80 shadow-sm dark:bg-slate-900/40 dark:border-slate-800 dark:shadow-none border border-slate-200 dark:border-slate-800 p-6 rounded-2xl backdrop-blur-md">
              <h2 className="text-base sm:text-lg font-bold text-emerald-600 dark:text-emerald-400 mb-6 flex items-center space-x-2">
                <span>⚡</span>
                <span>Quy Trình Học Tập Tối Ưu (5 Bước)</span>
              </h2>

              <div className="relative border-l-2 border-slate-200 dark:border-slate-800/60 dark:border-slate-800/60 ml-3.5 pl-5 space-y-6">
                ...
                <div className="relative">
                  ...
                  <span className="text-[10px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest block mb-0.5">Bước 1</span>
                  <h4 className="text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-200">Xác định mẫu câu chính</h4>
                ...
                <div className="relative">
                  <div className="absolute -left-[27px] top-0.5 w-3.5 h-3.5 rounded-full bg-emerald-500 border-2 border-slate-200 dark:border-slate-800 shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
                  <span className="text-[10px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest block mb-0.5">Bước 2</span>
                  <h4 className="text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-200">Học Từ vựng & Kanji tương ứng</h4>
                  <p className="text-xs text-slate-400 dark:text-slate-500 mt-1 leading-relaxed">
                ...
                <div className="relative">
                  <div className="absolute -left-[27px] top-0.5 w-3.5 h-3.5 rounded-full bg-emerald-500 border-2 border-slate-200 dark:border-slate-800 shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
                  <span className="text-[10px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest block mb-0.5">Bước 3</span>
                  <h4 className="text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-200">Ôn tập từ vựng chuyên sâu</h4>
                  <p className="text-xs text-slate-400 dark:text-slate-500 mt-1 leading-relaxed">
            ...
            <div className="bg-gradient-to-r from-blue-950/30 to-indigo-950/20 border border-blue-900/40 p-5 rounded-2xl">
              <h3 className="text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-200 mb-2 flex items-center space-x-1.5">
                <span>💡</span>
