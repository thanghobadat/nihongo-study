export interface RadicalInfo {
  ...
  level?: 'N5' | 'N4' | 'advanced'; // Cấp độ JLPT
}

// Sets of radicals by JLPT Level
export const N5_RADICALS_SET = new Set([
  '木', '人', '土', '宀', '子', '口', '示', '貝', '日', '立', '刀', '白', '言', '心', '門', '耳', '金', '車', '食', '馬', '雨', '田', '月', '行', '辶', '目', '見', '手', '火', '糸', '小', '女', '里', '犬', '竹', '父', '毋', '弓', '足', '水', '風', '青', '走', '广', '止', '用', '疒', '力', '襾', '一', '儿', '革', '匕', '十', '厶', '亻', '刂'
]);

export const N4_RADICALS_SET = new Set([
  '舌', '衣', '羽', '隹', '丶', '廴', '聿', '飛', '皮', '鳥', '士', '亠', '色', '韋', '己', '面', '斤', '艸', '巾', '网', '戶', '黃', '夂', '爪', '又', '尸', '自', '工', '攴', '欠', '寸', '虫', '殳', '丨', '卩', '石', '角', '八', '囗', '大', '谷', '皿', '頁', '禾', '艮', '歹', '辰', '米', '弋', '至', '羊', '戈', '勹', '比', '廾', '夕', '乙', '骨', '亅', '矢', '疋', '身', '方', '酉', '厂', '音', '邑', '入', '川', '矛', '冖', '彳', '臣', '彡'
]);

export function getRadicalLevel(character: string): 'N5' | 'N4' | 'advanced' {
  const clean = character.split(' ')[0];
  if (N5_RADICALS_SET.has(clean)) return 'N5';
  if (N4_RADICALS_SET.has(clean)) return 'N4';
  return 'advanced';
}
